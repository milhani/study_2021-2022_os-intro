...
![Обозначения имени и почты владельца репозитория](image/5.png)
...
![Настройка utf-8 в выводе сообщений в git](image/6.png)

6.	Теперь поработаем с ветками. Зададим имя начальной ветки и изменим параметры autocrlf и safecrlf. 

![Имя начальной ветки и изменение параметров autocrlf и safecrlf](image/7.png)

7.	Следующий шаг — создание ключей SSH и PGP. 

![Создание ключа SSH](image/8.png)

![Создание ключа PGP #1](image/9.png)

![Создание ключа PGP #2](image/10.png)
...
![Вывод ключей](image/11.png)

![Копирование ключа](image/12.png)

![Добавление ключа в Github #1](image/13.png)

![Добавление ключа в Github #2](image/14.png)

9.	Теперь можем настроить подпись коммитов.

![Настройка подписей коммитов](image/15.png)

10.	Авторизовываемся в gh и создаем шаблон для рабочего пространства.

![Авторизация в gh #1](image/16.png)

![Авторизация в gh #2](image/17.png)

![Создание шаблона](image/18.png)
...
git push
```
![Настройка каталога курса #1](image/19.png)

![Настройка каталога курса #2](image/20.png)
